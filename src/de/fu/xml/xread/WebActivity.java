...
public class WebActivity extends Activity{
	...
	/**	Wenn auf Button Stop geklickt wird in Web Ansicht, dann wird der Vorgang des Ladens abgebochen. */
	public void stopWeb(){
		//Falls Keyboard aufgeklappt ist, dann wieder zuklappen.
    	InputMethodManager imm = (InputMethodManager)getSystemService(Context.INPUT_METHOD_SERVICE);
    	if(imm.isAcceptingText())
    	...
    	webview.setWebViewClient(new WebViewClient(){
			...
			@Override
			 public void onPageFinished(WebView view, String url) {
				...
				progressWheel.setVisibility(View.INVISIBLE);
				Toast.makeText(getApplicationContext(), "Seite fertig geladen ...", Toast.LENGTH_SHORT).show();
			 }
